...
suite('Unit Tests', function () {
  ...
  assert.isNotTrue(Boolean('double negation'), 'Double negation of a truthy value is true');
  assert.isNotTrue(Boolean({}), 'Objects are truthy, but are not boolean values');
});
